...
def main() -> None:
    ...
    parser.add_argument("--tokens", nargs="+", default=None,
                        help="only visualize these sample tokens")
    ...
    if args.tokens is not None:
        ...
        dataset.data_infos = [i for i in dataset.data_infos if i["token"] in token_set]
        print(f"Filtering to {len(dataset.data_infos)} / {len(args.tokens)} tokens")
